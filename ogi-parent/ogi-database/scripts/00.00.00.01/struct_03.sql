...
BEGIN
	...
	DELETE FROM TA_EVENT WHERE PRO_REFERENCE=property_ref;
	INSERT INTO TA_EVENT(PRO_ID, PRO_REFERENCE, EVT_TYPE, EVT_TIMESTAMP) VALUES (proerty_id, property_ref, 'PRP_DELETE', NOW());
