...
@Service("serviceBienIci")
public class ServiceBienIciImpl extends AbstractService implements ServicePartner {
	private final Logger		LOGGER	= LoggerFactory.getLogger(ServiceBienIciImpl.class);
