...
@Service("serviceLeBonCoin")
public class ServiceLeBonCoinImpl extends AbstractService implements ServicePartner {
	private final Logger		LOGGER	= LoggerFactory.getLogger(ServiceLeBonCoinImpl.class);
