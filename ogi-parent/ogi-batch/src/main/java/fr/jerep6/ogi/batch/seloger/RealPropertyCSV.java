...
public class RealPropertyCSV {
	...
	@Setter
	private String	addresseCP;
	@Setter
	private String	addresseVille;
	private String	addressePays;
	private String	addresseRue;
	private String	addresseQuartier;
	...
	@Setter
	private String	honoraires;								// OBLIG. Montant des honoraires en euros TTC pour une
																// location
	@Setter
	...
	@Setter
	private String	libelle;									// OBLI (64 CHAR). Libellé court. Exemple : Maison 3
																// pièces
	...
	private String	typeResidence;								// (3 CHAR). Uniquement pour location de vacances
	...
	private String	intercabinet;								// Utilisé dans le cas ou l’agence dispose d’un site
																// géré
																// par
																// Seloger.com
	...
	private String	natureBail;								// Uniquement pour les location. Exemple : Location
																// meublée
	...
	private String	terrainViabilisé;							// OUI NON
