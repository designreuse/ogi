...
public class ProcessorTransformToCSV implements ItemProcessor<ExtractLeBonCoin, RealPropertyCSV> {
	...
	private ServicePartner						serviceLeBonCoin;
	...
	@Override
	public RealPropertyCSV process(ExtractLeBonCoin extract) throws Exception {
		RealProperty item = extract.getProperty();

		try {
			serviceLeBonCoin.validate(item);
	...
	public void setServiceLeBonCoin(ServicePartner serviceLeBonCoin) {
		this.serviceLeBonCoin = serviceLeBonCoin;
	}
